...
public class Table {
	 ...
	 * @param collection
	 *            Colección de campos. */
	public Table(@NonNull final Collection<String> collection) {
		fields = collection;
	}
	...
	public void setField(@NonNull final String... values) {
	 ...
	 * @param values
	 *            Valores a pintar separados por coma */
	public void setFieldNewLine(@NonNull final String... values) {
		Collections.addAll(fields, values);
		newLine();
	}
